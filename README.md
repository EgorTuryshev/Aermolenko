...
1. Создать файл "Rename.xlsx";
2. Назвать лист в созданном файле "agentTypeId";
3. В ячейке A1 вписать "old" и, начиная с ячейки "A2", вставить значения из таблицы "AgentTypeReady" из столбца "Title";
4. В ячейке B1 вписать "new" и, начиная с ячейки "A2", вставить значения из таблицы "AgentTypeReady" из столбца "Id";
5. Открыть скрипт “rename.py” и изменить значения следующих переменных:
   - Переменной “rename_path” присвоить значение полного пути расположения файла "Rename.xlsx";
   - Переменной “path” присвоить значение пути к файлу "AgentReady.xlsx" (без самого названия файла);
   - Переменной “file” присвоить значение "AgentReady.xlsx";
   - Переменной “sheet” присвоить значение "agentTypeId";
   - Переменной “column_index” присвоить значение 2;
...
Далее необходимо выполнить аналогичный алгоритм для файла "ProductReady" (переменной “column_index” присвоить значение 2) без создания нового файла "Rename.xlsx", а добавления в него нового листа "ProductTypeID".
...
Для создания sql-запросов необходимо:
1. Открыть скрипт “excel_to_sql.py” и изменить значения следующих переменных:
   - Переменной “excel_folder” дать значение расположения папки, в которой хранятся все файлы с данными для базы данных;
   - Перменной “dict” дать списком значения названий всех файлов с данными, в формате {‘название_файла_xlsx’: {‘table’: ‘название_таблицы_в_бд’, ‘sheet’: ‘название_листа_файла_xlsx’}, …};
...
1. Выполнить подключение к развернутой базе данных
2. В панелит инструментов выбрать "Редактор SQL" -> "Загрузить SQL скрпит" -> Выбрать файл "*_insert.sql". 
3. Выполнить загруженный SQL скрипт
