...
В ProductsImport.xlsx все еще проще - из столбца "Минимальная цена для агента" нужно убрать все упоминания рублей, оставив только цифры. Делаем всё аналогично тому, что описано выше.
